                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Text('20% discount on business class ticktsfrom ffffffff ',style: Style.headLineStyle2,)
                          ],
                        ),
                      ),
                      Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Discount\nfor survey', style: Style.headLineStyle2.copyWith(color: Colors.white),),
                                    SizedBox(height: 10,),
                                    Text('Take the survey about our services and get discount',style: Style.headLineStyle4.copyWith(color: Colors.white),),
                                  ],
                                ),
                              ),
                              Positioned(
